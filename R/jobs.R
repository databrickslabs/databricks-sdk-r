...
#'
#' @aliases jobs_create
jobs_create <- function(access_control_list=NULL, continuous=NULL, email_notifications=NULL, format=NULL, git_source=NULL, job_clusters=NULL, max_concurrent_runs=NULL, name=NULL, schedule=NULL, tags=NULL, tasks=NULL, timeout_seconds=NULL, webhook_notifications=NULL) {
    body <- list(
...
jobs_list <- function(expand_tasks=NULL, limit=NULL, name=NULL, offset=NULL) {
    ...
    query$offset = 0results <- data.frame()
    while (TRUE) {
...
jobs_list_runs <- function(active_only=NULL, completed_only=NULL, expand_tasks=NULL, job_id=NULL, limit=NULL, offset=NULL, run_type=NULL, start_time_from=NULL, start_time_to=NULL) {
    query <- list(
...
jobs_repair_run <- function(run_id, dbt_commands=NULL, jar_params=NULL, latest_repair_id=NULL, notebook_params=NULL, pipeline_params=NULL, python_named_params=NULL, python_params=NULL, rerun_all_failed_tasks=NULL, rerun_tasks=NULL, spark_submit_params=NULL, sql_params=NULL, timeout=20, callback=cli_reporter) {
    body <- list(
...
jobs_run_now <- function(job_id, dbt_commands=NULL, idempotency_token=NULL, jar_params=NULL, notebook_params=NULL, pipeline_params=NULL, python_named_params=NULL, python_params=NULL, spark_submit_params=NULL, sql_params=NULL, timeout=20, callback=cli_reporter) {
    body <- list(
        dbt_commands = dbt_commands
...
#'
#' @aliases jobs_submit
jobs_submit <- function(access_control_list=NULL, git_source=NULL, idempotency_token=NULL, run_name=NULL, tasks=NULL, timeout_seconds=NULL, webhook_notifications=NULL, timeout=20, callback=cli_reporter) {
    body <- list(
        access_control_list = access_control_list
        , git_source = git_source
        , idempotency_token = idempotency_token
