...
databricks_account_users_create <- function(id, active = NULL, 
    display_name = NULL, 
    emails = NULL, 
    entitlements = NULL, 
    external_id = NULL, 
    ...
    body <- list(
        ...
        roles = roles, 
        user_name = user_name, ...)
    .api$do("POST", paste("/api/2.0/accounts/", .api$account_id, "/scim/v2/Users", , sep = ""), body = body)
}
...
#'
#' @param id Unique ID for a user in the Databricks Account.
databricks_account_users_delete <- function(id, ...) {
    
    .api$do("DELETE", paste("/api/2.0/accounts/", .api$account_id, "/scim/v2/Users/", id, sep = ""))
}
...
#'
#' @param id Unique ID for a user in the Databricks Account.
databricks_account_users_get <- function(id, ...) {
    
    .api$do("GET", paste("/api/2.0/accounts/", .api$account_id, "/scim/v2/Users/", id, sep = ""))
}
...
databricks_account_users_list <- function(attributes = NULL, 
    count = NULL, 
    ...
    .api$do("GET", paste("/api/2.0/accounts/", .api$account_id, "/scim/v2/Users", , sep = ""), query = query)
}
...
#' @param operations 
databricks_account_users_patch <- function(id, operations = NULL, 
    ...) {
    body <- list(
        operations = operations, ...)
    .api$do("PATCH", paste("/api/2.0/accounts/", .api$account_id, "/scim/v2/Users/", id, sep = ""), body = body)
}
...
#' @param roles 
#' @param user_name Email address of the Databricks user.
databricks_account_users_update <- function(id, active = NULL, 
    display_name = NULL, 
    emails = NULL, 
    entitlements = NULL, 
    external_id = NULL, 
    ...
    body <- list(
        ...
        roles = roles, 
        user_name = user_name, ...)
    .api$do("PUT", paste("/api/2.0/accounts/", .api$account_id, "/scim/v2/Users/", id, sep = ""), body = body)
}
