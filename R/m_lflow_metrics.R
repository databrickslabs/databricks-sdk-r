...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=m_lflow_metrics_get_history]{get_history} \tab Get history of a given metric within a run.\cr
#' }
#'
#' @rdname m_lflow_metrics
#' @export
m_lflow_metrics <- list()
...
#' @keywords internal
#'
#' @rdname m_lflow_metrics_get_history
#'
#' @aliases m_lflow_metrics_get_history
m_lflow_metrics_get_history <- function(metric_key, max_results = NULL, page_token = NULL,
